...
class TestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test" do
    assert_difference("Test.count") do
      post tests_url, params: { test: { first_name: @test.first_name, last_name: @test.last_name } }
    end
  ...
  test "should update test" do
    patch test_url(@test), params: { test: { first_name: @test.first_name, last_name: @test.last_name } }
